<h1 align="center">Hi there, I'm Ansh Shah 👋</h1>
<h3 align="center">MS CS @ UIC | Full-Stack, Data Engineering, and ML Systems</h3>

<p align="center">
  <a href="https://github.com/AnshShah-18">
    <img src="https://komarev.com/ghpvc/?username=AnshShah-18&label=Profile%20views&color=0e75b6&style=flat" alt="profile views" />
  </a>
  <a href="https://github.com/AnshShah-18?tab=followers">
    <img src="https://img.shields.io/github/followers/AnshShah-18?label=Followers&style=social" alt="GitHub followers" />
  </a>
</p>

## About Me
- I am a Computer Science graduate student at the University of Illinois Chicago (Expected May 2026).
- I build end-to-end systems across full-stack apps, data engineering pipelines, and machine learning workflows.
- My interests include retrieval systems (RAG/GraphRAG), distributed processing, backend reliability, and developer-focused tools.
- I like turning complex data problems into practical, production-ready solutions.

## Education
- **University of Illinois Chicago** - Master of Science in Computer Science (GPA: 3.71), Expected May 2026
- **KJ Somaiya College of Engineering** - B.Tech in Information Technology (GPA: 3.6), May 2024

## Skills
<p>
  <img src="https://skillicons.dev/icons?i=python,js,scala,sql,react,nextjs,nodejs,fastapi,tensorflow,pytorch,postgres,mysql,aws,docker,kubernetes,git,linux" />
</p>

### Technical Areas
- **Programming:** Python, JavaScript, Scala, SQL
- **ML/AI:** Scikit-learn, TensorFlow, PyTorch, NLP pipelines
- **Data Engineering:** Apache Spark, Hadoop MapReduce, Apache Flink, Delta Lake
- **Databases & Analytics:** Neo4j, PostgreSQL, MySQL, Tableau
- **Cloud & Infra:** AWS (S3, EC2, EMR, EKS), Docker, Kubernetes
